...
export const Session = asDrizzleTable('Session', tables.Session);
export const Account = asDrizzleTable('Account', tables.Account);
export const Verification = asDrizzleTable('Verification', tables.Verification);
